	...
	<div class="card-body">
		<div class="filter">
			...
			<div class="d-inline-block">
				...
				<input type="text" class="form-control" id="searchstatus" name="searchstatus">
			</div><br>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="overflow: visible;">
				<form id="FormDeleteUser">
					...
					<input autocomplete="off" spellcheck="false" autocorrect="off" id="booking_id" name="booking_id" class="form-control d-none" type="text" readonly required>
					<div class="row">
						<div class="col-12">
...
<script type="text/javascript">
		...
		if (!$.fn.DataTable.isDataTable('#TableUsers')) {
			...
			TableUsers = $('#TableUsers').DataTable({
				...
				buttons: [{
					extend: 'excel',
					text: 'Excel',
					filename: 'List Booking',
					title: 'List Booking' + moment(new Date()).format("YYYY-MM-DD hh:mm:ss A"),
					exportOptions: {
				...
				columns: [{
					...
					data: null,
					render: function(data, type, row) {
						return '<a href="/booking/printbooking/' + row.id + '" class="btn badge badge-primary">View</a>';
					}
				}],
	...
	$(document).ready(function() {
		...
		$(document).on('click', '.btnDeleteUser', function(e) {
			...
			$('#FormDeleteUser #booking_id').val(_id);
