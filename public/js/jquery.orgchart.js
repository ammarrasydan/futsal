(function ($) {
    ...
    function Node(data) {
        ...
        this.formatNode = function (opts) {
            ...
            if (typeof data.datejoin !== 'undefined') {
                dateJoinString = '<p>' + self.data.datejoin + '</p>';
            }
            ...
            if (typeof data.hasHref !== 'undefined') {
                rtn = "<a href='" + data.hasHref + "' class='node' node-id='" + this.data.id + "'>" + nameString + descString + dateJoinString + buttonsHtml + "</a>";
            } else {
                rtn = "<div class='node' node-id='" + this.data.id + "'>" + nameString + descString + dateJoinString + buttonsHtml + "</div>";
            }
